...
./copy_and_package.sh gz linux_x64 /c/Development/JetBrainsProjects/CLion/BigFileCleaner/cmake-build-release-wsl-linux-x86_64 /c/Development/JetBrainsProjects/CLion/BigFileCleaner/cmake-build-release-wsl-linux-x86_64/temp BigFileCleaner.AppImage icons
