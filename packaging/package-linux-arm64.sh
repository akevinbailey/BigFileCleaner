...
./copy_and_package.sh gz linux_arm64 ~/Development/BigFileCleaner/cmake-build-release-wks-pi5 ~/Development/BigFileCleaner/cmake-build-release-wks-pi5/temp BigFileCleaner.AppImage icons
